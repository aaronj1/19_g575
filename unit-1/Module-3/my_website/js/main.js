...
function jQueryAjax(){
    ...
    $.ajax("data/MegaCities.geojson", {
           ...
           //check the data (defined and can be successfully accessed here)
           console.log(mydata);
           }
           });
    
    //check the data (undefined and cannot be accessed here)
    console.log(mydata);
};
...
function debugAjax(){
    ...
    function debugCallback(response){
        //append GeoJSON string data to mydiv
        $(mydiv).append('GeoJSON data: ' + JSON.stringify(mydata));
    };
    //jQuery ajax method that includes a callback function with a response
    $.ajax("data/MegaCities.geojson", {
           dataType: "json",
           success: function(response){
                mydata = response;
